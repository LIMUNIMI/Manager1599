...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/manager1599.exe

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/manager1599.exe: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}
	${LINK.c} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/manager1599 ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/managerLosElements.o: managerLosElements.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/managerLosElements.o managerLosElements.c
